...
#define MCLC_VERSION 0x030F0100; // v3.15.1, correspond to ECPW 2.6.1 (G121 version)
...
#if FEAT_MPG
	typedef enum {
		MCL_MPG_AXIS_MODE1,	// One bit represents one axis
		MCL_MPG_AXIS_MODE2	// Use 3 DI bits to represent up to 7 axes
	} MCL_MPG_AXIS_MODE;	// MPG: Axis selection mode
