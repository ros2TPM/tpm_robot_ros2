...
typedef enum {
	...
	ROB_ERR_OBJ_NO_AXIS,		// this object doesn't contain any axis.
	...
	ROB_ERR_ENABLED,			// Can't perform this operation while enabled
	ROB_ERR_CB_NOT_SET,			// callback is not registered

	// ====== Invalid Argument ===========
	ROB_ERR_INVALID_ARG = ROB_OK + 100,
	ROB_ERR_INVALID_GRPID,
	ROB_ERR_INVALID_AXISID,
	ROB_ERR_INVALID_OBJID,
	ROB_ERR_INVALID_CIR,
	ROB_ERR_MP_DIST_TOO_SHORT,
	ROB_ERR_NULL_POINTER,
	ROB_ERR_ITEM_NOT_FOUND,
	...
	ROB_ERR_AXIS_DISCONN,	// the axis can't move because of disconnect flag.
	ROB_ERR_AXIS_EMG,		// the axis can't move because of emergency flag.
	ROB_ERR_AXIS_ALM,		// the axis can't move because of alarm flag.
	ROB_ERR_AXIS_PEL,		// the axis can't move because of positive limit flag.
	ROB_ERR_AXIS_NEL,		// the axis can't move because of negative limit flag.
	ROB_ERR_AXIS_SOFT_PEL,	// the axis can't move because of positive soft limit.
	ROB_ERR_AXIS_SOFT_MEL,	// the axis can't move because of negative soft limit.
	ROB_ERR_AXIS_MAX_VEL,	// the axis can't move because the velocity of cmd exceed the max velocity of the axis.
	ROB_ERR_AXIS_MAX_ACC,	// the axis can't move because the acceleration of cmd exceed the max acceleration of the axis.
	ROB_ERR_AXIS_MAX_DEC,	// the axis can't move because the deceleration of cmd exceed the max deceleration of the axis.
	...
	ROB_ERR_CB_COND,	// error in cmd Wait.	 (CB_IsConditionMet return error)
...
typedef enum {
	...
	ROB_Delta_Pris_EndRot = 101, // Delta with prismatic actuator + rotational end effector
